...
(function(window, document, undefined) {'use strict';
 ...
 // EYAL VARDI PROXY
 let eyalHandler = new Proxy({}, {
  get(target, trapName, receiver) {
      // Return the handler method named trapName
      return function (...args) {
          //if(args[0] === angular && args[1] === 'module'){
            //console.dir(args);
          //}
  ...
  return ensure(angular, 'module', function() {   
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        console.log(`${name} module created. total modules: ${ Object.keys(modules).length}`);
        ...
        //return  new Proxy( moduleInstance , eyalHandler );
...
//window.angular = new Proxy( angular , eyalHandler );
